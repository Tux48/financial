...
from com.financial.kline.bean.KLine000Bean import KLine300Bean
from com.financial.kline.sm.KLineStateBase import KLineStateBase

class KLineState300( KLineStateBase ):
    
    __SQL = "select max(trade_date) from k_line_300 where ts_code=:tsCode"
