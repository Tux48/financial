...
from com.financial.kline.bean.KLine000Bean import KLine002Bean
from com.financial.kline.sm.KLineStateBase import KLineStateBase

class KLineState002( KLineStateBase ):
    
    __SQL = "select max(trade_date) from k_line_002 where ts_code=:tsCode"
