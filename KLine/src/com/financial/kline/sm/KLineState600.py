...
from com.financial.kline.bean.KLine000Bean import KLine600Bean
from com.financial.kline.sm.KLineStateBase import KLineStateBase

class KLineState600( KLineStateBase ):
    
    __SQL = "select max(trade_date) from k_line_600 where ts_code=:tsCode"
