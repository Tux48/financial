...
com.financial.ild.bean.IndexLineDay001Bean -- 数据bean

com.financial.ild.bean.IndexLineDay001Bean is a 
数据bean，对数据库中index_line_day_001表的映射
...
class IndexLineDaySZSEBean( Base ):
    
    ## 映身的数据库表名
    __tablename__ = "index_line_day_szse"
