...
com.financial.reinstated.bean.Reinstated002Bean -- 数据bean

com.financial.reinstated.bean.Reinstated002Bean is a 
数据bean，对数据库中reinstated_002表的映射
...
class Reinstated002Bean( Base ):
    
    ## 映身的数据库表名
    __tablename__ = "reinstated_002"
