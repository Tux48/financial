...
com.financial.reinstated.bean.ReinstatedNone300Bean -- 数据bean

com.financial.reinstated.bean.ReinstatedNone300Bean is a 
数据bean，对数据库中reinstated_none_300表的映射
...
class ReinstatedNone300Bean( Base ):
    
    ## 映身的数据库表名
    __tablename__ = "reinstated_none_300"
