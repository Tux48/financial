...
com.financial.reinstated.bean.ReinstatedNone002Bean -- 数据bean

com.financial.reinstated.bean.ReinstatedNone002Bean is a 
数据bean，对数据库中reinstated_none_002表的映射
...
class ReinstatedNone002Bean( Base ):
    
    ## 映身的数据库表名
    __tablename__ = "reinstated_none_002"
