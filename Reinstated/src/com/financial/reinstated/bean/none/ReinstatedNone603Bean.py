...
com.financial.reinstated.bean.ReinstatedNone603Bean -- 数据bean

com.financial.reinstated.bean.ReinstatedNone603Bean is a 
数据bean，对数据库中reinstated_none_603表的映射
...
class ReinstatedNone603Bean( Base ):
    
    ## 映身的数据库表名
    __tablename__ = "reinstated_none_603"
