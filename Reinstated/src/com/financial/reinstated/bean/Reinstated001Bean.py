...
com.financial.reinstated.bean.Reinstated001Bean -- 数据bean

com.financial.reinstated.bean.Reinstated001Bean is a 
数据bean，对数据库中reinstated_001表的映射
...
class Reinstated001Bean( Base ):
    
    ## 映身的数据库表名
    __tablename__ = "reinstated_001"
