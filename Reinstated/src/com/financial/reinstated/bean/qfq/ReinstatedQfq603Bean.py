...
com.financial.reinstated.bean.ReinstatedQfq603Bean -- 数据bean

com.financial.reinstated.bean.ReinstatedQfq603Bean is a 
数据bean，对数据库中reinstated_qfq_603表的映射
...
class ReinstatedQfq603Bean( Base ):
    
    ## 映身的数据库表名
    __tablename__ = "reinstated_qfq_603"
