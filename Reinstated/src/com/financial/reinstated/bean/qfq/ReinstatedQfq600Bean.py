...
com.financial.reinstated.bean.ReinstatedQfq600Bean -- 数据bean

com.financial.reinstated.bean.ReinstatedQfq600Bean is a 
数据bean，对数据库中reinstated_qfq_600表的映射
...
class ReinstatedQfq600Bean( Base ):
    
    ## 映身的数据库表名
    __tablename__ = "reinstated_qfq_600"
