...
com.financial.reinstated.bean.Reinstated603Bean -- 数据bean

com.financial.reinstated.bean.Reinstated603Bean is a 
数据bean，对数据库中reinstated_603表的映射
...
class Reinstated603Bean( Base ):
    
    ## 映身的数据库表名
    __tablename__ = "reinstated_603"
