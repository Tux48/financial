...
com.financial.reinstated.bean.ReinstatedHfq603Bean -- 数据bean

com.financial.reinstated.bean.ReinstatedHfq603Bean is a 
数据bean，对数据库中reinstated_hfq_603表的映射
...
class ReinstatedHfq603Bean( Base ):
    
    ## 映身的数据库表名
    __tablename__ = "reinstated_hfq_603"
