...
com.financial.reinstated.bean.ReinstatedHfq001Bean -- 数据bean

com.financial.reinstated.bean.ReinstatedHfq001Bean is a 
数据bean，对数据库中reinstated_hfq_001表的映射
...
class ReinstatedHfq001Bean( Base ):
    
    ## 映身的数据库表名
    __tablename__ = "reinstated_hfq_001"
