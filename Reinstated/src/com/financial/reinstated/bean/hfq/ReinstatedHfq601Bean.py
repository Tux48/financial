...
com.financial.reinstated.bean.ReinstatedHfq601Bean -- 数据bean

com.financial.reinstated.bean.ReinstatedHfq601Bean is a 
数据bean，对数据库中reinstated_hfq_601表的映射
...
class ReinstatedHfq601Bean( Base ):
    
    ## 映身的数据库表名
    __tablename__ = "reinstated_hfq_601"
