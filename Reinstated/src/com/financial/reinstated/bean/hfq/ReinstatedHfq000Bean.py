...
com.financial.reinstated.bean.ReinstatedHfq000Bean -- 数据bean

com.financial.reinstated.bean.ReinstatedHfq000Bean is a 
数据bean，对数据库中reinstated_hfq_000表的映射
...
class ReinstatedHfq000Bean( Base ):
    
    ## 映身的数据库表名
    __tablename__ = "reinstated_hfq_000"
