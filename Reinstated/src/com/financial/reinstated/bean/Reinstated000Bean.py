...
com.financial.reinstated.bean.Reinstated000Bean -- 数据bean

com.financial.reinstated.bean.Reinstated000Bean is a 
数据bean，对数据库中reinstated_000表的映射
...
class Reinstated000Bean( Base ):
    
    ## 映身的数据库表名
    __tablename__ = "reinstated_000"
