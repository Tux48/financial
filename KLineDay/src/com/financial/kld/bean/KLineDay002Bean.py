...
com.financial.kld.bean.KLineDay002Bean -- 数据bean

com.financial.kld.bean.KLineDay002Bean is a 
数据bean，对数据库中k_line_day_002表的映射
...
class KLineDay002Bean( Base ):
    
    ## 映身的数据库表名
    __tablename__ = "k_line_day_002"
