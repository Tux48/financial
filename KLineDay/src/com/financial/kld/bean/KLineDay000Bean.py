...
com.financial.kld.bean.KLineDay000Bean -- 数据bean

com.financial.kld.bean.KLineDay000Bean is a 
数据bean，对数据库中k_line_day_000表的映射
...
class KLineDay000Bean( Base ):
    
    ## 映身的数据库表名
    __tablename__ = "k_line_day_000"
