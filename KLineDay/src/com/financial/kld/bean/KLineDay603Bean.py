...
com.financial.kld.bean.KLineDay603Bean -- 数据bean

com.financial.stockbasic.bean.KLineDay603Bean is a 
数据bean，对数据库中k_line_day_603表的映射
...
class KLineDay603Bean( Base ):
    
    ## 映身的数据库表名
    __tablename__ = "k_line_day_603"
