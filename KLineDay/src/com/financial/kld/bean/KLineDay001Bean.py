...
com.financial.kld.bean.KLineDay001Bean -- 数据bean

com.financial.kld.bean.KLineDay001Bean is a 
数据bean，对数据库中k_line_day_001表的映射
...
class KLineDay001Bean( Base ):
    
    ## 映身的数据库表名
    __tablename__ = "k_line_day_001"
