...
com.financial.ta.bean.TargetDay000Bean -- 数据bean

com.financial.ta.bean.TargetDay000Bean is a 
数据bean，对数据库中target_day_000表的映射
...
class TargetDay000Bean( Base ):
    
    ## 映身的数据库表名
    __tablename__ = "target_day_000"
