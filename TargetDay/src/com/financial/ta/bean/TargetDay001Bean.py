...
com.financial.ta.bean.TargetDay001Bean -- 数据bean

com.financial.ta.bean.TargetDay001Bean is a 
数据bean，对数据库中target_day_001表的映射
...
class TargetDay001Bean( Base ):
    
    ## 映身的数据库表名
    __tablename__ = "target_day_001"
