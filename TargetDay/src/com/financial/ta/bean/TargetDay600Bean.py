...
com.financial.ta.bean.TargetDay600Bean -- 数据bean

com.financial.ta.bean.TargetDay600Bean is a 
数据bean，对数据库中target_day_600表的映射
...
class TargetDay600Bean( Base ):
    
    ## 映身的数据库表名
    __tablename__ = "target_day_600"
