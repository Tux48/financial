...
com.financial.ta.bean.TargetDay002Bean -- 数据bean

com.financial.ta.bean.TargetDay002Bean is a 
数据bean，对数据库中target_day_002表的映射
...
class TargetDay002Bean( Base ):
    
    ## 映身的数据库表名
    __tablename__ = "target_day_002"
