...
com.financial.klw.bean.KLineWeek000Bean -- 数据bean

com.financial.klw.bean.KLineWeek000Bean is a 
数据bean，对数据库中k_line_week_000表的映射
...
class KLineWeek000Bean( Base ):
    
    ## 映身的数据库表名
    __tablename__ = "k_line_week_000"
