...
com.financial.klw.bean.KLineWeek002Bean -- 数据bean

com.financial.klw.bean.KLineWeek002Bean is a 
数据bean，对数据库中k_line_week_002表的映射
...
class KLineWeek002Bean( Base ):
    
    ## 映身的数据库表名
    __tablename__ = "k_line_week_002"
