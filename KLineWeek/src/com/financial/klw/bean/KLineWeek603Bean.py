...
com.financial.klw.bean.KLineWeek603Bean -- 数据bean

com.financial.klw.bean.KLineWeek603Bean is a 
数据bean，对数据库中k_line_week_603表的映射
...
class KLineWeek603Bean( Base ):
    
    ## 映身的数据库表名
    __tablename__ = "k_line_week_603"
