...
com.financial.klm.bean.KLineMonth601Bean -- 数据bean

com.financial.klm.bean.KLineMonth601Bean is a 
数据bean，对数据库中k_line_month_601表的映射
...
class KLineMonth601Bean( Base ):
    
    ## 映身的数据库表名
    __tablename__ = "k_line_month_601"
