...
com.financial.klm.bean.KLineMonth300Bean -- 数据bean

com.financial.klm.bean.KLineMonth300Bean is a 
数据bean，对数据库中k_line_Month_300表的映射
...
class KLineMonth300Bean( Base ):
    
    ## 映身的数据库表名
    __tablename__ = "k_line_month_300"
