...
com.financial.klm.bean.KLineMonth002Bean -- 数据bean

com.financial.klm.bean.KLineMonth002Bean is a 
数据bean，对数据库中k_line_Month_002表的映射
...
class KLineMonth002Bean( Base ):
    
    ## 映身的数据库表名
    __tablename__ = "k_line_month_002"
